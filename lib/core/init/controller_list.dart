...
import '../../features/landing/presentation/providers/landing_page_provider.dart';
...
List<SingleChildWidget> controllerList = [ 
  ...
  ChangeNotifierProvider<LandingPageProvider>(create: (BuildContext context) => LandingPageProvider()),
];